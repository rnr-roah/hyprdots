-- Converted from animations.conf
-- Your file had two active animations blocks. The second one overrides/re-adds some leaves,
-- so both are preserved in order.
...
-- Curves from yugaaank dotfiles section
...
-- Second active block from your file
